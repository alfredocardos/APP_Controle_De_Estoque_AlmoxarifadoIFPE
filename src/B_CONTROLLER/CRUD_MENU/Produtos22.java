...
import B_CONTROLLER.Crud_ElementoDeDespesa_22;
...
public class Produtos22 {
    private static final Scanner sc = new Scanner(System.in);
    private static final Crud_ElementoDeDespesa_22 crud_elementoDeDespesa_22 = new Crud_ElementoDeDespesa_22();
    ...
    public static void Cadastro() throws SQLException {
        ...
        crud_elementoDeDespesa_22.Cadastro(p1);

    }

    public static void Update() throws SQLException {
        crud_elementoDeDespesa_22.Update();
    }

    public static void Saida() throws Exception {
        crud_elementoDeDespesa_22.SaidadeMaterial();
    }

    public static void Produtos() throws SQLException {
        Optional<List<Produtos>> produtos = crud_elementoDeDespesa_22.PesquisarPeloElementodeDespesa();
        produtos.stream().forEach(s -> System.out.println(s));

    }

    public static void Tipo_Produtos() throws SQLException {
        Optional<List<A_MODEL.Produtos>> Tprodutos = crud_elementoDeDespesa_22.PesquisarPeloElementodeDespesaDoProduto();
